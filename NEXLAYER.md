...
**Live:** [https://relaxed-weasel-humhub.cloud.nexlayer.ai](https://relaxed-weasel-humhub.cloud.nexlayer.ai)  
...
**humhub** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/humhub/humhub:latest
    path: /
    servicePorts:
    - 80
    vars:
      HUMHUB_DB_HOST: mysql.pod
    ...
    - name: humhub-uploads
      ...
      size: 5Gi
    - name: humhub-protected
      mountPath: /var/www/localhost/htdocs/protected/runtime
      size: 2Gi
  - name: mysql
